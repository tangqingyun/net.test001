...
namespace uni2uni.com.Framework.Drawing
{
    ...
    public class ValidateImage
    {
        ...
        {
           // this.CreateCheckCodeImage(CharHelper.GenerateCheckCode(5));
        }
        ...
        {
            return GetImgMemoryStream(checkCode, fettle, textcolor, 110, 50);
        }
