...
namespace MSSQL
{
    public class ReflectHelper
    {
        ...
        /// <returns></returns>
        public static T PopulateChangeFromIDataReader<T>(IDataReader dr)
        {
            if (dr == null)
            {
        ...
        private static void SetPropertyValue(PropertyInfo[] allPropertyArray, DataRow dr, DataColumn column)
        {
            ...
            {
                if (!property.Name.Equals(column.ColumnName)) continue;
        ...
        /// <returns></returns>
        public static string GetSQL<T>(EnumAction action, out IList<DbParameter> listParameter, string tableName = null)
        {
